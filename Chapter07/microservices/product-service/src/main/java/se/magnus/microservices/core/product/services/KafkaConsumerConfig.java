...
public class KafkaConsumerConfig {
  ...
  @Bean
  public ConsumerFactory<Integer, Event<Integer, Product>> consumerFactoryJson() {
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<Integer, Event<Integer, Product>> kafkaListenerContainerFactoryJson() {

    ConcurrentKafkaListenerContainerFactory<Integer, Event<Integer, Product>> factory = new ConcurrentKafkaListenerContainerFactory<>();
